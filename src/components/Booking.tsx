      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <Reveal>
            ...
            <a
              href="#demo"
              className="btn-primary mt-8 inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-semibold shadow-glow transition-transform hover:scale-[1.03]"
            >
            ...
            <div className="glass relative rounded-3xl p-6 shadow-soft sm:p-8">
              ...
              <div className="relative flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="mt-1 flex items-center gap-1 text-luna-300">
              ...
              <div className="mt-5 flex items-center gap-2 rounded-xl bg-luna-300/10 px-4 py-3 text-sm text-foreground/75">
                ...
                {["09:00", "09:30", "10:00", "10:30", "11:00", "14:00"].map(
                  (t, i) =>
                    i === 3 ? (
                      <button
                        key={t}
                        className="btn-primary rounded-xl border border-transparent px-3 py-2.5 text-sm font-medium"
                      >
                        {t}
                      </button>
                    ) : (
                      <button
                        key={t}
                        className="panel rounded-xl px-3 py-2.5 text-sm font-medium text-foreground/80 transition-colors hover:border-accent"
                      >
                        {t}
                      </button>
                    ),

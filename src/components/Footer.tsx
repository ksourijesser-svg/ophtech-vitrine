...
export default function Footer() {
  return (
    <footer className="relative border-t border-luna-300/10 bg-luna-900">
      <div className="mx-auto max-w-7xl px-5 py-14 sm:px-8">
        <div className="grid gap-10 lg:grid-cols-[1.4fr_1fr_1fr_1fr]">
          <div>
            <a href="#top" className="flex items-center gap-2.5">
              ...
              <span className="text-lg font-semibold text-cloud">Ophtech</span>
            </a>
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-cloud/55">
          ...
          {cols.map((c) => (
            <div key={c.title}>
              <p className="text-sm font-semibold text-cloud">{c.title}</p>
              <ul className="mt-4 space-y-3">
                {c.links.map((l) => (
                  <li key={l.label}>
                    <a
                      href={l.href}
                      className="text-sm text-cloud/55 transition-colors hover:text-luna-100"
                    >
                      {l.label}
                    </a>
                  </li>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-luna-300/10 pt-6 sm:flex-row">
          <p className="text-sm text-cloud/45">
